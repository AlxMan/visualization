...
import com.wxc.common.CityProvinceConverter;
import com.wxc.common.ServerResponse;
import com.wxc.mapper.CountryMapMapper;
...
public class CountryMapServiceImpl  implements ICountryMapService {
    ...
    public ServerResponse<List<ProvinceVo>> getMapData() {
        //1.查询各个省份有哪些城市  并封装到List<ProvinceVo>   没有城市招聘数量
        List<ProvinceVo>  provinceVoList = mapper.queryProvinceCity();

        //2.查询每个城市招聘数量 并封装到List<CityVo>  有城市招聘数量
